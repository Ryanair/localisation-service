...
{
	public class TransLangLogsMap : ClassMapping<TransLangLogs>
	{

		public TransLangLogsMap()
		{
			Table("Trans_LangLogs");
			Schema("dbo");
			Lazy(true);
			...
			Property(x => x.TransDescription, map => map.Column("transDescription"));
